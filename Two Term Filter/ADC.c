...
{	
    ...
    ADC_RegularChannelConfig(ADC3,ADC_Channel_1, 1,ADC_SampleTime_28Cycles5); // define regular conversion config
    ADC_Init ( ADC3, &ADC_InitStructure);   //set config of ADC1
